...
func NewSearchStep(chunkRepository odm.OdmCollectionInterface[db.ChunkModel], vectorRepository odm.OdmCollectionInterface[db.ChunkAnnModel], embedder embed.Embedder) *SearchStep {
	return &SearchStep{
