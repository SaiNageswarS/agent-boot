...
import (
	...
	"github.com/SaiNageswarS/agent-boot/example/appconfig"
...
type AgentService struct {
	...
	embdder         embed.Embedder
}

func ProvideAgentService(mongo odm.MongoClient, anthropicClient *llm.AnthropicClient, ollamaClient *llm.OllamaLLMClient, embedder embed.Embedder, ccfgg *appconfig.AppConfig) *AgentService {
	return &AgentService{
		mongo:           mongo,
